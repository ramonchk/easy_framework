<?php
class xssClean {
    public static function clean_input( $input, $safe_level = 0 ) {
        $output = $input;
        do {
            $input = $output;
    ...
    private static function strip_encoded_entities( $input ) {
    ...
    private static function strip_tags( $input ) {
    ...
    private static function strip_base64( $input ) {
